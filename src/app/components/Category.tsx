    ...
    <section className="py-10 px-4">
      <div className="w-full flex justify-center items-center mt-10 mb-10">
        <div className="w-full sm:w-[90%] md:w-[80%]">
          ...
          {/* Category Buttons */}
          <div className="w-full grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-9">
            {[
              {
                name: "Phones",
              ...
              <div
                key={idx}
                className="group flex flex-col items-center justify-center w-full h-32 border-2 border-gray-400 bg-white text-center cursor-pointer hover:bg-red-500 transition-all duration-300"
              >
                {/* Icon */}
                <div className="text-black group-hover:text-white">{category.icon}</div>
                {/* Text */}
